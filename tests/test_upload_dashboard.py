...
stub = types.ModuleType("requests"); stub.post = lambda *a, **k: None; sys.modules["requests"] = stub
import json
import os

spec = importlib.util.spec_from_file_location(
    'upload_dashboard', Path(__file__).resolve().parents[1] / 'scripts' / 'upload_dashboard.py'
)
