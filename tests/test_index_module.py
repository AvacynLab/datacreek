...
def test_recall10_property():
    ...
    G = nx.Graph()
    G.add_node("a", embedding=[1.0, 0.0], graphwave_embedding=[1.0, 0.0], poincare_embedding=[1.0, 0.0])
    G.add_node("b", embedding=[0.0, 1.0], graphwave_embedding=[0.0, 1.0], poincare_embedding=[0.0, 1.0])
