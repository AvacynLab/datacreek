...
def test_explain_to_svg_empty():
    ...
    assert svg == '<svg xmlns="http://www.w3.org/2000/svg" width="10" height="10"></svg>'
...
def test_explain_to_svg_basic_edge():
    ...
    assert svg.startswith('<svg xmlns="http://www.w3.org/2000/svg" width="160.0" height="160.0"')
    # Line element with computed color and stroke-width
    assert '<line x1="160.0" y1="80.0" x2="0.0" y2="80.0" stroke="rgb(127,0,127)" stroke-width="2.0" />' in svg
