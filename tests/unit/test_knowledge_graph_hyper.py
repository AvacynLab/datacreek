...
def test_hyperbolic_reasoning_helpers(monkeypatch):
    ...
    assert kg.hyperbolic_multi_curvature_reasoning('c1', 'c2', curvatures=[0.1]) == ['c1', 'c2']
...
def test_fractal_levels_and_dimensions(monkeypatch):
    ...
    monkeypatch.setattr(KnowledgeGraph, 'box_counting_dimension', lambda self, r: (2.0, [(1, 2)]))
